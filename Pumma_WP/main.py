...
def write_to_file(data):
    ...
    header = "TS,water_level_pressure,forecast_30,forecast_300,alert_signal,rms_alert_signal,threshold,alert_level"
    try:
        if not os.path.exists(filepath):
            with open(filepath, "w") as file:
                file.write(header)
        with open(filepath, "a") as file:
            row = f"{data['TS']},{data['Water_level_Pressure']},{data['For30']},{data['For300']},{data['Alert_Signal']},{data['rms']},{data['Threshold']},{data['Alert_Level']}\n"
            file.write(row)
        ...
        try:
            ...
            if alert_level > 0:
                ...
                message = (
                    ...
                    f"Water Colum Height: {data['Water_level_Pressure']}\n"
