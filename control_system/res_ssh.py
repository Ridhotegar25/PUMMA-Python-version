...
def on_connect(client, userdata, flags, rc):
    if rc == 0:
        ...
        client.subscribe("")  # Isi ke topik Sebesi_ssh yg ditentukan example : sebesi_ssh
    else:
    ...
    try:
        ...
        if payload == "1":
            ...
            if result == 0:
                ...
                client.publish("Nama Tempat_ssh_response", "success")  # Kirim pesan sukses ke broker
            else:
                print("Failed to restart SSH service.")
                client.publish("Nama Tempat_ssh_response", "failure")  # Kirim pesan gagal ke broker
