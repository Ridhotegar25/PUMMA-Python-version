...
def on_connect(client, userdata, flags, rc):
    if rc == 0:
        ...
        client.subscribe("")  # Ubah Topic sesuai yg ditentukan example Sebesi_reboot 
    else:
    ...
    try:
        ...
        if payload == "1":
            ...
            if result == 0:
                ...
                client.publish("ubah ke nama tempat yg dituju_reboot_response", "success_reboot")  # Kirim pesan sukses ke broker
            else:
                print("Failed to restart SSH service.")
                client.publish("ubah ke nama tempat yg dituju_reboot_response", "failure")  # Kirim pesan gagal ke broker
